...
(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b2) {
        return apply1(map43($$const(identity2))(a2))(b2);
      };
    };
  };
              ...
              if (rm instanceof Left) {
                return bind18(v1)(function(rn) {
                  ...
                  if (rn instanceof Left) {
                    return pure19(new Left(append11(rm.value0)(rn.value0)));
                  }
                  ;
    ...
    return function(f) {
      return function(b2) {
        return runFn3(unconsImpl)(function(v) {
          ...
          return function(as) {
            return bind18(f(b2)(a2))(function(b$prime) {
  ...
  var foldableCofree = function(dictFoldable) {
    ...
    return {
      ...
      foldl: function(f) {
        var go2 = function(b2) {
          return function(fa) {
            return foldl16(go2)(f(b2)(head3(fa)))(tail(fa));
          };
        };
        return go2;
      },
  ...
  var buildEdgeBundleData = function(nodesCSV) {
    return function(edgesCSV) {
      ...
      var importsMap = foldl2(addImport)(empty5)(edges2);
      var nodes2 = map10(function(name16) {
        return {
          name: name16,
    ...
    return function(inputTree) {
      ...
      var renderInternal = function(currentLeafX) {
        return function(t) {
          ...
          ;
          var processChildren = foldl16(function(acc) {
  ...
  var applyLinks = function(outgoingMap) {
    return function(incomingMap) {
      return function(v) {
        var outgoing4 = fromMaybe([])(lookup4(v.value0.fullName)(outgoingMap));
        var incoming4 = fromMaybe([])(lookup4(v.value0.fullName)(incomingMap));
  ...
  var buildHierarchy = function(config) {
    return function(nodes2) {
      ...
      var treeWithNodes = foldl9(insertNode(config.getName))(emptyRoot)(nodes2);
  ...
  var packSiblingsMap = function(inputCircles) {
    ...
    if (v2 instanceof Just && (v1 instanceof Just && v instanceof Just)) {
      ...
      var finalState = foldl11(flip(addCircle))(initialState3)(remaining);
  ...
  var computeBaseSeparations = function(minSep) {
    return function(separationFn) {
      return function(nodes2) {
        ...
        if (nodes2 instanceof Nil) {
          return Nil.value;
        }
        ;
        if (nodes2 instanceof Cons && nodes2.value1 instanceof Nil) {
          return Nil.value;
        }
        ;
        return zipWith2(getSep(separationFn)(minSep))(nodes2)(tailSafe(nodes2));
      };
    };
  };
  ...
  var outgoing = function(dictOrd) {
    ...
    return function(node) {
      return function(v) {
        return fromMaybe([])(lookup10(node)(v.forward));
      };
    };
  };
  var incoming = function(dictOrd) {
    ...
    return function(node) {
      return function(v) {
        return fromMaybe([])(lookup10(node)(v.reverse));
      };
    };
  };
  var empty7 = {
      ...
      return function(target6) {
        return function(weight) {
          return function(v) {
            ...
            return {
              nodeSet: insert10(source2)(insert10(target6)(v.nodeSet)),
  ...
  var unsafeFromWeightedDigraph = DAG;
  var unsafeAddEdge = function(dictOrd) {
    var addEdge3 = addEdge2(dictOrd);
    return function(source2) {
      return function(target6) {
        return function(weight) {
          return function(v) {
            return addEdge3(source2)(target6)(weight)(v);
          };
        };
      };
    };
  };
  var outgoing2 = function(dictOrd) {
    var outgoing1 = outgoing(dictOrd);
    return function(node) {
      return function(v) {
        return outgoing1(node)(v);
      };
    };
  };
  var incoming2 = function(dictOrd) {
    var incoming1 = incoming(dictOrd);
    return function(node) {
      return function(v) {
        return incoming1(node)(v);
      };
    };
  };
  ...
  var initialSankeyGraphModel = function(config) {
    return {
      ...
      nodeIDToName: empty5,
      nodeOrder: [],
      graph: unsafeFromWeightedDigraph(empty7),
      sankeyNodes: [],
      sankeyLinks: [],
      config,
      capturedSteps: []
  ...
  var fromFoldable12 = /* @__PURE__ */ fromFoldable11(foldableArray)(ordNodeID);
  var outgoing3 = /* @__PURE__ */ outgoing2(ordNodeID);
  var incoming3 = /* @__PURE__ */ incoming2(ordNodeID);
  var initialiseSankeyNode = function(m) {
    return function(id4) {
      return bind5(lookup6(id4)(m.nodeIDToName))(function(name16) {
        var sourceLinks = fromFoldable12(map27(function(v) {
          return v.target;
        })(outgoing3(id4)(m.graph)));
        var targetLinks = fromFoldable12(map27(function(v) {
          return v.source;
        })(incoming3(id4)(m.graph)));
        return pure8({
          name: name16,
          x0: 0,
          x1: 0,
  ...
  var fromFoldable13 = /* @__PURE__ */ fromFoldable11(foldableArray)(ordNodeID);
        ...
        return function(padding2) {
          return function(y0) {
            return function(y1) {
              ...
              var calculateKy = function(layers2) {
                return function(height9) {
                  return function(padding1) {
                    ...
                    var scales = map28(scaleForLayer)(layers2);
                    ...
                    ;
                    throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 403, column 7 - line 405, column 23): " + [v.constructor.name]);
                  };
                };
              };
              ...
              var positionedLayers = map28(positionLayer(ky)(padding2)(y0))(layers);
              ...
              var updateNodes = function(allNodes) {
                return function(updated) {
                  return map28(function(node) {
                    ...
                    ;
                    throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 826, column 11 - line 828, column 28): " + [v.constructor.name]);
                  })(allNodes);
                };
              };
                              ...
                              function $tco_loop(idx, y2, currentNodes) {
                                ...
                                if (v instanceof Just) {
                                  ...
                                  var newY = (function() {
                                    ...
                                    ;
                                    throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 813, column 22 - line 815, column 29): " + [v1.constructor.name]);
                                  })();
                                  $tco_var_idx = idx + 1 | 0;
                                  $tco_var_y = newY;
                                ...
                                ;
                                throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 800, column 14 - line 817, column 40): " + [v.constructor.name]);
                              }
                              ;
                              while (!$tco_done) {
                              ...
                              function $tco_loop(idx, y2, currentNodes) {
                                ...
                                if (v instanceof Just) {
                                  ...
                                  var newY = (function() {
                                    ...
                                    ;
                                    throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 782, column 24 - line 784, column 31): " + [v1.constructor.name]);
                                  })();
                                  $tco_var_idx = idx - 1 | 0;
                                  $tco_var_y = newY;
                                  $copy_currentNodes = updated;
                                ...
                                ;
                                throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 769, column 16 - line 786, column 42): " + [v.constructor.name]);
                              }
                              ;
                              while (!$tco_done1) {
                                $tco_result = $tco_loop($tco_var_idx, $tco_var_y, $copy_currentNodes);
                    ...
                    return function(yMax) {
                      return function(beta2) {
                        ...
                        var startYDown = (function() {
                          ...
                          ;
                          throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 745, column 22 - line 747, column 26): " + [middleNode.constructor.name]);
                        })();
                        var startYUp = (function() {
                          ...
                          ;
                          throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 737, column 20 - line 739, column 26): " + [middleNode.constructor.name]);
                        })();
                    ...
                    return function(padding1) {
                      ...
                      var result = foldl2(function(acc) {
                        return function(link3) {
                          ...
                          ;
                          throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 563, column 13 - line 573, column 29): " + [v.constructor.name]);
                        };
                      })({
                        sum: 0,
                        totalWeight: 0
                    ...
                    return function(padding1) {
                      ...
                      var result = foldl2(function(acc) {
                        return function(link3) {
                          ...
                          ;
                          throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 601, column 13 - line 610, column 29): " + [v.constructor.name]);
                        };
                      })({
                        sum: 0,
                        totalWeight: 0
                      ...
                      return function(ascending) {
                        return function(alpha) {
                          return function(beta2) {
                            ...
                            var layerNodeIndices = map28(function(v) {
                              return v.index;
                            })(sortedLayerNodes);
                            var nodesAfterRelax = foldl2(function(nodes1) {
                              return function(nodeIdx) {
                                ...
                                ;
                                throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 506, column 13 - line 523, column 82): " + [v.constructor.name]);
                              };
                            ...
                            var sortedWithTarget = map28(function(node) {
                              return {
                                node,
                                targetY: node.y0
                              };
  ...
  var computeNodeHeights = /* @__PURE__ */ (function() {
        ...
        return function($copy_current) {
          return function($copy_maxHeight) {
            ...
            function $tco_loop(nodes2, height9, current, maxHeight) {
              ...
              ;
              throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 223, column 3 - line 223, column 84): " + [nodes2.constructor.name, height9.constructor.name, current.constructor.name, maxHeight.constructor.name]);
            }
            ;
            while (!$tco_done) {
    ...
    return bind6(get4)(function(model) {
      ...
      var initialCurrent = fromFoldable13(map28(function(v) {
        return v.index;
      })(sinkNodes));
        ...
        return function($copy_current) {
          return function($copy_maxDepth) {
            ...
            function $tco_loop(nodes2, depth, current, maxDepth) {
              ...
              ;
              throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 181, column 3 - line 181, column 83): " + [nodes2.constructor.name, depth.constructor.name, current.constructor.name, maxDepth.constructor.name]);
            }
            ;
            while (!$tco_done) {
  ...
  var computeLinkBreadths = /* @__PURE__ */ (function() {
        ...
        var linksWithY0 = foldl2(function(currentLinks) {
          return function(node) {
            ...
            return map28(function(link3) {
              ...
              ;
              throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 911, column 21 - line 913, column 38): " + [v.constructor.name]);
            })(currentLinks);
          };
        })(links)(nodes2);
        var linksWithY1 = foldl2(function(currentLinks) {
          return function(node) {
            ...
            return map28(function(link3) {
              ...
              ;
              throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 952, column 21 - line 954, column 38): " + [v.constructor.name]);
            })(currentLinks);
          };
        })(linksWithY0)(nodes2);
        return linksWithY1;
      ...
      return function(y0) {
        return function(y1) {
          return function(padding2) {
            ...
            var scales = map28(scaleForLayer)(layers);
            var nonEmptyScales = filter(function(s) {
              return s > 0;
            })(scales);
            var v = head(nonEmptyScales);
            ...
            ;
            throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 871, column 7 - line 873, column 23): " + [v.constructor.name]);
          };
        };
      };
    };
    return bind6(get4)(function(model) {
      ...
      var linksWithWidth = map28(function(link3) {
        return {
          value: link3.value,
          color: link3.color,
          index: link3.index,
    ...
    return function(y0) {
      return function(y1) {
        return function(padding2) {
          ...
          ;
          throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 272, column 5 - line 274, column 21): " + [v.constructor.name]);
        };
      };
    };
  };
    ...
    var assignLinkColor = function(nodes2) {
      return function(mode) {
        return function(link3) {
          ...
          ;
          throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 997, column 7 - line 1012, column 29): " + [mode.constructor.name]);
        };
      };
    };
  ...
  var alignNodeToLayer = function(alignment) {
    return function(node) {
      return function(numLayers) {
        ...
        ;
        throw new Error("Failed pattern match at DataViz.Layout.Sankey.Compute (line 348, column 3 - line 358, column 13): " + [alignment.constructor.name]);
      };
    };
  };
    ...
    return function(config) {
      return function(x0) {
        return function(x1) {
          ...
          var nodesWithLayer = map28(function(node) {
          ...
          var nodesWithX = map28(function(node) {
  ...
  var generateLinkPath = function(nodes2) {
    return function(link3) {
      var targetNode = findNode2(nodes2)(link3.targetIndex);
      var sourceNode = findNode2(nodes2)(link3.sourceIndex);
  ...
  var fromFoldable14 = /* @__PURE__ */ fromFoldable11(foldableArray)(ordString);
                    ...
                    return function(datum) {
                      ...
                      if (itemTree instanceof Elem) {
                        return function __do2() {
                          ...
                          return {
                            element: el,
                            childSelections: foldl2(union5)(empty5)(map32(function(v) {
                              return v.selections;
                            })(childMaps)),
                            transitions
                          };
            ...
            if (v instanceof MkFold) {
              return runSomeFold(v.value0)(function(foldSpec) {
                ...
                return function __do2() {
                  ...
                  var elements = map32(function(v1) {
                    return v1.element;
                  })(results);
                  var childMaps = foldl2(union5)(empty5)(map32(function(v1) {
                    return v1.childSelections;
                  })(results));
                  return {
                    selections: insert7(foldSpec.name)(elements)(childMaps),
                    entering: [catMaybes(map32(function(v1) {
            ...
            return function(v) {
              ...
              if (v instanceof MkFold) {
                return runSomeFold(v.value0)(function(spec) {
                  ...
                  var newKeys = fromFoldable14(map32(spec.keyFn)(items2));
                  ...
                  return function __do2() {
                    ...
                    var existingKeys = fromFoldable14(map32(function(v1) {
                      return v1.key;
                    })(existingKeysAndEls));
                    ...
                    var updateElements = map32(function(v1) {
                      return v1.element;
                    })(filter(function(v1) {
                      return member4(v1.key)(updateKeys);
                    })(existingKeysAndEls));
                    var enterElements = map32(function(v1) {
                      return v1.element;
                    })(enterResults);
                    var childMaps = foldl2(union5)(empty5)(map32(function(v1) {
                      return v1.childSelections;
      ...
      return function(v) {
        var kids = (function() {
          ...
          if (v.children instanceof Just) {
            return map33(go2(depth + 1 | 0))(v.children.value0);
          }
          ;
  ...
  var flattenNodes = function(tree2) {
    ...
    var children2 = fromFoldable15(tail(tree2));
  ...
  var buildTreemap = function(nodes2) {
    ...
    return elem4(SVG.value)([viewBox(0)(0)(400)(400), preserveAspectRatio("xMidYMid meet")])([elem4(Group.value)([transform("translate(10,10)")])([forEach("rects")(Rect.value)(nodes2)(function(v) {
      return v.path;
    })(function(node) {
  ...
  var renderTreemap = function(selector) {
    return function(hierData) {
      ...
      var nodes2 = flattenTreemapNodes(treemapped);
      var tree2 = buildTreemap(nodes2);
      return function __do2() {
  ...
  var buildTreeVertical = function(offsetX2) {
    return function(offsetY2) {
      return function(color) {
        return function(nodes2) {
          return function(links) {
            var nodesLayer = forEach("nodes")(Group.value)(nodes2)(function(v) {
              return v.path;
            })(function(node) {
  ...
  var renderClusterVertical = function(selector) {
    return function(inputTree) {
      ...
      var nodes2 = flattenNodes(laidOut);
      var tree2 = buildTreeVertical(40)(25)(colorMalachite)(nodes2)(links);
      return function __do2() {
        rerender(selector)(tree2)();
        return unit;
      };
  ...
  var renderTreeVertical = function(selector) {
    return function(inputTree) {
      ...
      var links = extractLinks(laidOut);
      var nodes2 = flattenNodes(laidOut);
      var tree2 = buildTreeVertical(40)(25)(colorForestGreen)(nodes2)(links);
      return function __do2() {
        rerender(selector)(tree2)();
        return unit;
      };
  ...
  var buildTreeRadial = function(color) {
    return function(nodes2) {
      return function(links) {
        var nodesLayer = forEach("nodes")(Circle.value)(nodes2)(function(v) {
          return v.path;
        })(function(node) {
  ...
  var renderClusterRadial = function(selector) {
    return function(inputTree) {
      ...
      var links = extractLinks(laidOut);
      var nodes2 = flattenNodes(laidOut);
      var tree2 = buildTreeRadial(colorMalachite)(nodes2)(links);
      return function __do2() {
        rerender(selector)(tree2)();
        return unit;
      };
  ...
  var renderTreeRadial = function(selector) {
    return function(inputTree) {
      ...
      var links = extractLinks(laidOut);
      var nodes2 = flattenNodes(laidOut);
      var tree2 = buildTreeRadial(colorGoldLeaf)(nodes2)(links);
      return function __do2() {
        rerender(selector)(tree2)();
        return unit;
      };
  ...
  var renderClusterHorizontal = function(selector) {
    return function(inputTree) {
      ...
      var links = extractLinks(laidOut);
      var nodes2 = flattenNodes(laidOut);
      var tree2 = buildTreeHorizontal(25)(40)(colorMalachite)(nodes2)(links);
      return function __do2() {
        rerender(selector)(tree2)();
        return unit;
      };
  ...
  var renderTreeHorizontal = function(selector) {
    return function(inputTree) {
      ...
      var links = extractLinks(laidOut);
      var nodes2 = flattenNodes(laidOut);
      var tree2 = buildTreeHorizontal(40)(25)(colorForestGreen)(nodes2)(links);
      return function __do2() {
        rerender(selector)(tree2)();
        return unit;
      };
  ...
  var buildSunburst = function(radius) {
    return function(nodes2) {
      ...
      return elem4(SVG.value)([viewBox(0)(0)(400)(400), preserveAspectRatio("xMidYMid meet")])([elem4(Group.value)([transform("translate(200,200)")])([forEach("arcs")(Path.value)(nodes2)(function(v) {
        return v.path;
      })(function(node) {
  ...
  var renderSunburst = function(selector) {
    return function(hierData) {
      ...
      var nodes2 = flattenPartitionNodes(partitioned);
      var tree2 = buildSunburst(170)(nodes2);
      return function __do2() {
        rerender(selector)(tree2)();
        return unit;
      };
  ...
  var buildSankey = function(nodes2) {
    return function(links) {
      var nodesLayer = forEach("sankey-nodes")(Rect.value)(nodes2)(function(v) {
        return v.name;
      })(function(node) {
        var w = node.x1 - node.x0;
  ...
  var buildPack = function(nodes2) {
    ...
    return elem4(SVG.value)([viewBox(0)(0)(400)(400), preserveAspectRatio("xMidYMid meet")])([elem4(Group.value)([transform("translate(10,10)")])([forEach("circles")(Circle.value)(nodes2)(function(v) {
      return v.path;
    })(function(node) {
  ...
  var renderPack = function(selector) {
    return function(hierData) {
      ...
      var nodes2 = flattenPackNodes(packed);
      var tree2 = buildPack(nodes2);
      return function __do2() {
        rerender(selector)(tree2)();
        return unit;
      };
  ...
  var buildEdgeBundle = function(nodes2) {
    return function(links) {
      var nodesLayer = forEach("bundle-nodes")(Circle.value)(nodes2)(function(v) {
        return v.fullName;
      })(function(node) {
        return withBehaviors([onCoordinatedHighlight({
  ...
  var runGraft = /* @__PURE__ */ unGraft(function(v) {
    var go2 = function(v2) {
      ...
      if (v2 instanceof Elem2) {
        return new Elem2(v2.value0, v2.value1, v.value0(v2.value2), map34(go2)(v2.value3));
      }
      ;
      if (v2 instanceof Keyed) {
        return new Keyed(v2.value0, v2.value1, v.value0(v2.value2), map34(map115(go2))(v2.value3));
      }
      ;
  ...
  var renderHeader = /* @__PURE__ */ div2([/* @__PURE__ */ class_2("gallery-header")])([/* @__PURE__ */ h1_([/* @__PURE__ */ text5("Layout Gallery (HATS)")]), /* @__PURE__ */ p([/* @__PURE__ */ class_2("subtitle")])([/* @__PURE__ */ text5("14 100% PureScript layout algorithms \u2014 fully HATS-rendered")]), /* @__PURE__ */ p([/* @__PURE__ */ class_2("hint")])([/* @__PURE__ */ text5("(hover any element to see coordinated highlighting)")]), /* @__PURE__ */ p([/* @__PURE__ */ class_2("gallery-nav")])([/* @__PURE__ */ a([/* @__PURE__ */ href4("#masonry")])([/* @__PURE__ */ text5("Masonry Demo \u2192")])])]);
  var renderFooter = /* @__PURE__ */ div2([/* @__PURE__ */ class_2("gallery-footer")])([/* @__PURE__ */ p_([/* @__PURE__ */ text5("From the "), /* @__PURE__ */ a([/* @__PURE__ */ href4("https://github.com/afcondon/purescript-d3-layout")])([/* @__PURE__ */ text5("hylograph-layout")]), /* @__PURE__ */ text5(" library \u2014 Pure PureScript + HATS")])]);
  var layoutTypeAttr = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Gallery.ComponentHATS (line 146, column 1 - line 146, column 39): " + [v.constructor.name]);
  };
  ...
  var renderHATSLayouts = function(state3) {
    return function __do2() {
      (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gallery.ComponentHATS (line 183, column 3 - line 202, column 77): " + [state3.flareData.constructor.name]);
      })();
      (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gallery.ComponentHATS (line 205, column 3 - line 208, column 67): " + [state3.flowData.sankey.constructor.name]);
      })();
      (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gallery.ComponentHATS (line 211, column 3 - line 215, column 73): " + [state3.flowData.matrix.constructor.name]);
      })();
      ...
      ;
      throw new Error("Failed pattern match at Gallery.ComponentHATS (line 218, column 3 - line 221, column 75): " + [state3.flowData.edgeBundle.constructor.name]);
    };
  };
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind10(liftAff2(loadFlareData))(function(flareResult) {
          return discard22(handleAction(dictMonadAff)(new DataLoaded(flareResult)))(function() {
      ...
      if (v instanceof DataLoaded) {
        ...
        ;
        throw new Error("Failed pattern match at Gallery.ComponentHATS (line 243, column 5 - line 254, column 39): " + [v.value0.constructor.name]);
      }
      ;
      if (v instanceof SankeyLoaded) {
        ...
        ;
        throw new Error("Failed pattern match at Gallery.ComponentHATS (line 257, column 5 - line 261, column 39): " + [v.value0.constructor.name]);
      }
      ;
      if (v instanceof MatrixLoaded) {
        ...
        ;
        throw new Error("Failed pattern match at Gallery.ComponentHATS (line 264, column 5 - line 268, column 39): " + [v.value0.constructor.name]);
      }
      ;
      if (v instanceof EdgeBundleLoaded) {
        ...
        ;
        throw new Error("Failed pattern match at Gallery.ComponentHATS (line 271, column 5 - line 275, column 39): " + [v.value0.constructor.name]);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Gallery.ComponentHATS (line 228, column 16 - line 279, column 41): " + [v.constructor.name]);
    };
  };
      ...
      return function(vp) {
        return function(heights) {
          var shortestCol = function(colHeights) {
            ...
            return fromMaybe(0)(map36(function(v) {
              return v.i;
              ...
              return function(item) {
                ...
                ;
                throw new Error("Failed pattern match at DataViz.Layout.Pattern (line 522, column 25 - line 524, column 74): " + [acc.constructor.name]);
              };
            })(Nothing.value)(indexed)));
          };
          var area2 = usableArea(vp);
          var actualCols = max13(1)(cols2);
  ...
  var renderHeader2 = /* @__PURE__ */ div2([/* @__PURE__ */ class_2("gallery-header")])([/* @__PURE__ */ h1_([/* @__PURE__ */ text5("Masonry Layout")]), /* @__PURE__ */ p([/* @__PURE__ */ class_2("subtitle")])([/* @__PURE__ */ text5("Pinterest-style column packing \u2014 shortest column gets the next item")]), /* @__PURE__ */ p([/* @__PURE__ */ class_2("hint")])([/* @__PURE__ */ a([/* @__PURE__ */ href4("#")])([/* @__PURE__ */ text5("\u2190 Back to Gallery")])])]);
  ...
  var generateHeights = function(n) {
    return function __do2() {
      var randoms = traverse4(function(v) {
        return random;
      })(replicate(n)(unit))();
      return map37(function(r2) {
        return 40 + r2 * 160;
      })(randoms);
    };
  };
  var generateLayout = function(dictMonadEffect) {
    ...
    return bind12(get6)(function(state3) {
      return bind12(liftEffect8(generateHeights(25)))(function(heights) {
  ...
  var colorAt = function(i2) {
    var v = index(palette)(mod5(i2)(length(palette)));
    if (v instanceof Just) {
      return v.value0;
    }
    ;
  ...
  var renderViewport = function(state3) {
    var bounds = foldl15(function(acc) {
      return function(r2) {
        return {
          maxX: max14(acc.maxX)(r2.x + r2.width),
          maxY: max14(acc.maxY)(r2.y + r2.height)
        };
      };
    })({
      maxX: 0,
    ...
    var svgH = max14(100)(bounds.maxY);
    var svgW = max14(100)(bounds.maxX);
    var vb = "0 0 " + (show10(svgW) + (" " + show10(svgH)));
    return div2([class_2("masonry-viewport")])([svgElem([attr3("viewBox")(vb), attr3("preserveAspectRatio")("xMidYMin meet"), attr3("width")("100%")])(mapWithIndex2(renderRect)(state3.rects))]);
  };
  var colButtons = function(currentCols) {
    return mapFlipped5(range2(2)(5))(function(n) {
  ...
  var renderControls = function(currentCols) {
    return div2([class_2("masonry-controls")])(append18([span4([class_2("masonry-label")])([text5("Columns:")])])(append18(colButtons(currentCols))([button2([classes(["masonry-btn", "masonry-btn-regen"]), onClick(function(v) {
      return Regenerate.value;
    })])([text5("Regenerate")])])));
  };
  var render4 = function(state3) {
    return div2([class_2("masonry-demo")])([renderHeader2, renderControls(state3.columns), renderViewport(state3)]);
  };
  ...
  var runUI2 = function(component4) {
    return function(i2) {
      return function(element3) {
        return bind16(liftEffect6(map42(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
